...
export const aboutData = [
  ...
  // },
  {
    ...
    info: [
      {
        title: "Full-Stack web Developer - Droop Media Company",
        stage: "2023 - 2024",
      },
      {
        title: "Front-End  Developer - kensoftware",
        stage: "2024 - present",
      },
    ],
  },
  {
    ...
    info: [
      {
        title: "Web Development - Orange Coding Academy",
        stage: "2023",
      },
      {
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <motion.div
        ...
        animate="show"
        exit="hidden"
        className="hidden xl:flex absolute bottom-0 z-0 -left-[370px]"
      >
        <Avatar />
      </motion.div>
